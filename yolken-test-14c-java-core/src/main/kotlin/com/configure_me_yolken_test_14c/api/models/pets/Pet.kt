...
package com.configure_me_yolken_test_14c.api.models.pets

import com.configure_me_yolken_test_14c.api.core.Enum
import com.configure_me_yolken_test_14c.api.core.ExcludeMissing
...
import com.configure_me_yolken_test_14c.api.core.checkKnown
import com.configure_me_yolken_test_14c.api.core.checkRequired
import com.configure_me_yolken_test_14c.api.core.toImmutable
...
private constructor(
    ...
    /**
     * @throws YolkenTest14cInvalidDataException if the JSON field has an unexpected type or is
    ...
    /**
     * @throws YolkenTest14cInvalidDataException if the JSON field has an unexpected type (e.g. if
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: YolkenTest14cInvalidDataException) {
            false
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws YolkenTest14cInvalidDataException if this class instance's value is a not a known
         *   member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw YolkenTest14cInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws YolkenTest14cInvalidDataException if this class instance's value does not have
         *   the expected primitive type.
         */
        fun asString(): String =
            _value().asString().orElseThrow {
                YolkenTest14cInvalidDataException("Value is not a String")
            }
    ...
    private constructor(
        ...
        /**
         * @throws YolkenTest14cInvalidDataException if the JSON field has an unexpected type (e.g.
