...
/**
 * A client for interacting with the Yolken Test 14c REST API synchronously. You can also switch to
...
interface YolkenTest14cClient {
     ...
     * this client.
     */
    fun async(): YolkenTest14cClientAsync
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): YolkenTest14cClient
    ...
    /**
     * A view of [YolkenTest14cClient] that provides access to raw HTTP responses for each method.
     */
