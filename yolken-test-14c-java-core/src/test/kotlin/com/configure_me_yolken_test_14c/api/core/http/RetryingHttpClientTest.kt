...
import com.configure_me_yolken_test_14c.api.client.okhttp.OkHttpClient
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw YolkenTest14cRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            YolkenTest14cRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
