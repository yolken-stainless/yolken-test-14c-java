...
package com.configure_me_yolken_test_14c.api.client.okhttp

import com.configure_me_yolken_test_14c.api.client.YolkenTest14cClientAsync
import com.configure_me_yolken_test_14c.api.client.YolkenTest14cClientAsyncImpl
import com.configure_me_yolken_test_14c.api.core.ClientOptions
import com.configure_me_yolken_test_14c.api.core.Sleeper
import com.configure_me_yolken_test_14c.api.core.Timeout
import com.configure_me_yolken_test_14c.api.core.http.Headers
import com.configure_me_yolken_test_14c.api.core.http.HttpClient
import com.configure_me_yolken_test_14c.api.core.http.QueryParams
import com.configure_me_yolken_test_14c.api.core.jsonMapper
...
/**
 * A class that allows building an instance of [YolkenTest14cClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class YolkenTest14cOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [YolkenTest14cClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): YolkenTest14cClientAsync = builder().fromEnv().build()
    }

    /** A builder for [YolkenTest14cOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.configure_me_yolken_test_14c.api.core.jsonMapper]. The default is
        ...
        /**
         * Returns an immutable instance of [YolkenTest14cClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): YolkenTest14cClientAsync =
            YolkenTest14cClientAsyncImpl(
                clientOptions
                    .httpClient(
