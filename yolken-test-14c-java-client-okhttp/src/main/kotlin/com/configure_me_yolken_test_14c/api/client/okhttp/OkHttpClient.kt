...
import com.configure_me_yolken_test_14c.api.core.http.HttpRequestBody
import com.configure_me_yolken_test_14c.api.core.http.HttpResponse
import com.configure_me_yolken_test_14c.api.errors.YolkenTest14cIoException
...
private constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw YolkenTest14cIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(YolkenTest14cIoException("Request failed", e))
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("YOLKEN_TEST_14C_LOG")?.lowercase()) {
