...
import com.configure_me_yolken_test_14c.api.client.YolkenTest14cClientImpl
...
/**
 * A class that allows building an instance of [YolkenTest14cClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class YolkenTest14cOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [YolkenTest14cClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): YolkenTest14cClient = builder().fromEnv().build()
    }

    /** A builder for [YolkenTest14cOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [YolkenTest14cClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): YolkenTest14cClient =
            YolkenTest14cClientImpl(
                clientOptions
                    .httpClient(
