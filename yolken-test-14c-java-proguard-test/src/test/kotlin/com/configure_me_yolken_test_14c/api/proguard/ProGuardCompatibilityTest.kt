...
package com.configure_me_yolken_test_14c.api.proguard
...
internal class ProGuardCompatibilityTest {
    ...
    fun proguardRules() {
        val rulesFile =
            javaClass.classLoader.getResourceAsStream(
                "META-INF/proguard/yolken-test-14c-java-core.pro"
            )
    ...
    @Test
    fun client() {
        val client = YolkenTest14cOkHttpClient.builder().apiKey("My API Key").build()
