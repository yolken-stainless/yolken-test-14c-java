...
dependencies {
    testImplementation(project(":yolken-test-14c-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../yolken-test-14c-java-core/src/main/resources/META-INF/proguard/yolken-test-14c-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.configure_me_yolken_test_14c.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../yolken-test-14c-java-core/src/main/resources/META-INF/proguard/yolken-test-14c-java-core.pro",
